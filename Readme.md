...
# Parsing + Configuration Script – TRB140 - Rev. A

This **Parsing + Configuration** script is designed for the **TRB140** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TRB140 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TRB140** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
